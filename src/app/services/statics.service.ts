...
import { Static, StaticDbTableContext, Tags } from '../models/business/database/static.model';
...
export class StaticsService {
    ...
    getMetric$(metricValue: string, before: Date, after: Date): Observable<Static[]> {
