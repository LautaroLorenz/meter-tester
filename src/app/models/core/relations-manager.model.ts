...
export class RelationsManager {
    ...
    private static createForeignProp(element: any, foreignTables: ForeignTable[], relations: TableRelationsMap) {
        foreignTables.forEach((ft) => {
            ...
            if (ft.foreignTables) {
                this.createForeignProp(element.foreign[ft.propertyName], ft.foreignTables, relations);
            }
        });
    }
}
