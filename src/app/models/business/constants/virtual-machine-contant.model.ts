...
export const VMResponseTypesConstant = [
    {
        ...
        label: 'Automática',
        helpText: 'Apenas llega un comando, se envía la respuesta, según el mapeo de comandos'
    },
    {
...
export const VMDelayTypesConstant = [
    ...
    },
    {
        ...
        helpText: 'Responder luego de un delay aleatorio entre un rango mínimo y máximo'
    }
];
