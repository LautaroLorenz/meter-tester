...
export interface StepFormBuilder<T extends EssayTemplateStep, K extends Partial<EssayStep>> {
...
export abstract class AbstractStepFormBuilder<T extends EssayTemplateStep, K extends Partial<EssayStep>>
    implements StepFormBuilder<T, K>
{
    form!: AbstractFormGroup<T> | AbstractFormGroup<K>;
    fb!: FormBuilder;
    abstract build(fb: FormBuilder): StepFormBuilder<T, K>;
    abstract withExecutionProps(this: StepFormBuilder<T, K>): StepFormBuilder<T, K>;
    abstract withVerificationProps(this: StepFormBuilder<T, K>): StepFormBuilder<T, K>;
}
