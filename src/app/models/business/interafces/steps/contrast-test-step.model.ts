...
export class ContrastTestFormBuilder extends AbstractStepFormBuilder<ContrastTestStep, ContrastTestEssayStep> {
        ...
        this.form = fb.nonNullable.group({
            ...
            form_control_raw: fb.nonNullable.group({
                ...
                phaseL1: fb.nonNullable.group({
                    ...
                    powerFactor: [undefined, [Validators.required.bind(this), Validators.min(0), Validators.max(1)]],
                ...
                maxAllowedError: [
                    undefined,
                    [Validators.required.bind(this), Validators.min(0), Validators.max(99.99)]
                ],
                meterPulses: [undefined, [Validators.required.bind(this), Validators.min(0), Validators.max(999)]]
            }),
            foreign: undefined
    ...
    override withExecutionProps(this: ContrastTestFormBuilder): ContrastTestFormBuilder {
    ...
    override withVerificationProps(this: ContrastTestFormBuilder): ContrastTestFormBuilder {
        const typedForm = this.form as AbstractFormGroup<ContrastTestStep>;
