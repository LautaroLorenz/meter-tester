...
export class BootTestFormBuilder extends AbstractStepFormBuilder<BootTestStep, BootTestEssayStep> {
    override build(fb: FormBuilder): BootTestFormBuilder {
        ...
        this.form = fb.nonNullable.group({
            ...
            form_control_raw: fb.nonNullable.group({
                ...
                allowedPulses: [undefined, [Validators.required.bind(this), Validators.min(0), Validators.max(99)]],
                minDurationSeconds: [
                    undefined,
                    [Validators.required.bind(this), Validators.min(0), Validators.max(9999)]
                ],
                maxDurationSeconds: [
                    undefined,
                    [Validators.required.bind(this), Validators.min(0), Validators.max(9999)]
    ...
    override withVerificationProps(this: BootTestFormBuilder): BootTestFormBuilder {
        const typedForm = this.form as AbstractFormGroup<BootTestStep>;
