...
export class InputErrorComponent implements ControlValueAccessor, AfterViewInit, OnDestroy {
    ...
    ngAfterViewInit(): void {
        ...
        formControl?.statusChanges?.pipe(takeUntil(this.onDestroy)).subscribe(() => {
