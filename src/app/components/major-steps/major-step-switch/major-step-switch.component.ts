...
export class MajorStepSwitchComponent {
    ...
    getCurrentMajorStep(majorStepStatusMap: Record<MajorSteps, StepStatus>): MajorSteps {
        const [currentMajorStep] =
            Object.entries(majorStepStatusMap).find(([, stepStatus]) => stepStatus === StepStatus.Current) || [];
